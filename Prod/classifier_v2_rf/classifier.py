...
class classifier_loop():
    def __init__(self, input_detector_threshold, input_std, input_indent_signal, input_cooling_time, model_path):
        
        self.cropper = crop.DataStruct(detector_th = input_detector_threshold,
                              mstd_th =  input_detector_threshold,
                              mstd_wdw = input_std,
                              indent = input_indent_signal,
                              N_wait_frames = input_cooling_time)
    ...
    def classify(self, signal):
        ...
        classes = ['Strong_hit', 'Weak_hit', 'Perelaz', 'Pila']
...
if __name__ == '__main__':
    input_detector_threshold = 150
    input_std = 32
    input_indent_signal = 500
    input_cooling_time = 1
    model_path = 'random_forest.pkl'
    cl = classifier_loop(input_detector_threshold, input_std, input_indent_signal, input_cooling_time,model_path)
    cl.classifier_on()
