...
class Cropper():
    """
    Cropper - прослойка между бэкендом для получения данных и классификатором.
    Он выполняет несколько функций:
    1) Детектирование тревоги из сырого сигнала.
    2) Обрезка сигнала с учетом:
        a) Максимальной длительности сигнала.
        б) Времени охлаждения.
